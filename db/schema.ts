...
export const captainAccounts = sqliteTable("captain_accounts", {
  id: integer("id").primaryKey({ autoIncrement: true }),
...
export const captainTeamMemberships = sqliteTable("captain_team_memberships", {
  id: integer("id").primaryKey({ autoIncrement: true }),
...
export const captainTeamInvitations = sqliteTable("captain_team_invitations", {
  id: integer("id").primaryKey({ autoIncrement: true }),
  teamId: integer("team_id").notNull().references(() => teams.id, { onDelete: "cascade" }),
...
export const teamSeasons = sqliteTable("team_seasons", {
  id: integer("id").primaryKey({ autoIncrement: true }),
  teamId: integer("team_id").notNull().references(() => teams.id, { onDelete: "cascade" }),
  sourceUrl: text("source_url").notNull(),
...
export const playerProfileLinks = sqliteTable("player_profile_links", {
  id: integer("id").primaryKey({ autoIncrement: true }),
...
export const seasonPlayerStats = sqliteTable("season_player_stats", {
  id: integer("id").primaryKey({ autoIncrement: true }),
...
export const seasonFixtures = sqliteTable("season_fixtures", {
  id: integer("id").primaryKey({ autoIncrement: true }),
  teamSeasonId: integer("team_season_id").notNull().references(() => teamSeasons.id, { onDelete: "cascade" }),
  round: text("round").notNull().default("Fixture"),
  matchDate: text("match_date").notNull(),
...
export const syncedMatches = sqliteTable("synced_matches", {
  id: integer("id").primaryKey({ autoIncrement: true }),
  teamSeasonId: integer("team_season_id").references(() => teamSeasons.id, { onDelete: "set null" }),
...
export const matchInnings = sqliteTable("match_innings", {
  id: integer("id").primaryKey({ autoIncrement: true }),
...
export const matchPairs = sqliteTable("match_pairs", {
  id: integer("id").primaryKey({ autoIncrement: true }),
...
export const matchOvers = sqliteTable("match_overs", {
  id: integer("id").primaryKey({ autoIncrement: true }),
...
export const matchDeliveries = sqliteTable("match_deliveries", {
  id: integer("id").primaryKey({ autoIncrement: true }),
...
export const performanceClaims = sqliteTable("performance_claims", {
  id: integer("id").primaryKey({ autoIncrement: true }),
...
export const matchKudos = sqliteTable("match_kudos", {
  id: integer("id").primaryKey({ autoIncrement: true }),
  syncedMatchId: integer("synced_match_id").notNull().references(() => syncedMatches.id, { onDelete: "cascade" }),
  playerProfileId: integer("player_profile_id").notNull().references(() => playerProfiles.id, { onDelete: "cascade" }),
  createdAt: text("created_at").notNull().default(sql`CURRENT_TIMESTAMP`),
...
export const challengeEntries = sqliteTable("challenge_entries", {
  id: integer("id").primaryKey({ autoIncrement: true }),
  playerProfileId: integer("player_profile_id").notNull().references(() => playerProfiles.id, { onDelete: "cascade" }),
...
export const playerFollows = sqliteTable("player_follows", {
  id: integer("id").primaryKey({ autoIncrement: true }),
