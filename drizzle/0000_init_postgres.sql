CREATE TABLE "captain_accounts" (
	"id" integer PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY (sequence name "captain_accounts_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START WITH 1 CACHE 1),
	"email" text NOT NULL,
...
CREATE TABLE "captain_team_invitations" (
	"id" integer PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY (sequence name "captain_team_invitations_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START WITH 1 CACHE 1),
...
CREATE TABLE "captain_team_memberships" (
	"id" integer PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY (sequence name "captain_team_memberships_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START WITH 1 CACHE 1),
...
CREATE TABLE "challenge_entries" (
	"id" integer PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY (sequence name "challenge_entries_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START WITH 1 CACHE 1),
...
CREATE TABLE "fixtures" (
	"id" integer PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY (sequence name "fixtures_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START WITH 1 CACHE 1),
...
CREATE TABLE "match_comments" (
	"id" integer PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY (sequence name "match_comments_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START WITH 1 CACHE 1),
...
CREATE TABLE "match_deliveries" (
	"id" integer PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY (sequence name "match_deliveries_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START WITH 1 CACHE 1),
...
CREATE TABLE "match_innings" (
	"id" integer PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY (sequence name "match_innings_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START WITH 1 CACHE 1),
	"synced_match_id" integer NOT NULL,
...
CREATE TABLE "match_kudos" (
	"id" integer PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY (sequence name "match_kudos_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START WITH 1 CACHE 1),
	"synced_match_id" integer NOT NULL,
	"player_profile_id" integer NOT NULL,
	"created_at" text NOT NULL
);
...
CREATE TABLE "match_overs" (
	"id" integer PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY (sequence name "match_overs_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START WITH 1 CACHE 1),
...
CREATE TABLE "match_pairs" (
	"id" integer PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY (sequence name "match_pairs_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START WITH 1 CACHE 1),
...
CREATE TABLE "match_performances" (
	"id" integer PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY (sequence name "match_performances_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START WITH 1 CACHE 1),
	"synced_match_id" integer NOT NULL,
	"team_name" text NOT NULL,
	"player_name" text NOT NULL,
	"runs" double precision DEFAULT 0 NOT NULL,
	"strike_rate" double precision DEFAULT 0 NOT NULL,
	"overs_bowled" double precision DEFAULT 0 NOT NULL,
	"runs_conceded" double precision DEFAULT 0 NOT NULL,
	"wickets" integer DEFAULT 0 NOT NULL,
	"economy" double precision DEFAULT 0 NOT NULL,
...
CREATE TABLE "performance_claims" (
	"id" integer PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY (sequence name "performance_claims_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START WITH 1 CACHE 1),
	"player_profile_id" integer NOT NULL,
...
CREATE TABLE "player_follows" (
	"id" integer PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY (sequence name "player_follows_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START WITH 1 CACHE 1),
...
CREATE TABLE "player_profile_links" (
	"id" integer PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY (sequence name "player_profile_links_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START WITH 1 CACHE 1),
...
CREATE TABLE "player_profiles" (
	"id" integer PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY (sequence name "player_profiles_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START WITH 1 CACHE 1),
	"display_name" text NOT NULL,
...
CREATE TABLE "players" (
	...
	"runs" double precision DEFAULT 0 NOT NULL,
	"runs_average" double precision DEFAULT 0 NOT NULL,
	"strike_rate" double precision DEFAULT 0 NOT NULL,
	"times_out" integer DEFAULT 0 NOT NULL,
	"overs_bowled" double precision DEFAULT 0 NOT NULL,
	"wickets" integer DEFAULT 0 NOT NULL,
	"wicket_average" double precision DEFAULT 0 NOT NULL,
	"runs_conceded" double precision DEFAULT 0 NOT NULL,
	"runs_conceded_average" double precision DEFAULT 0 NOT NULL,
	"contribution" double precision DEFAULT 0 NOT NULL,
	"contribution_average" double precision DEFAULT 0 NOT NULL
);
--> statement-breakpoint
CREATE TABLE "season_fixtures" (
	"id" integer PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY (sequence name "season_fixtures_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START WITH 1 CACHE 1),
...
CREATE TABLE "season_player_stats" (
	"id" integer PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY (sequence name "season_player_stats_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START WITH 1 CACHE 1),
	"team_season_id" integer NOT NULL,
	"player_profile_id" integer NOT NULL,
...
CREATE TABLE "synced_matches" (
	"id" integer PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY (sequence name "synced_matches_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START WITH 1 CACHE 1),
	"team_season_id" integer,
...
CREATE TABLE "team_invitations" (
	"id" integer PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY (sequence name "team_invitations_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START WITH 1 CACHE 1),
	"team_id" integer NOT NULL,
	"player_name" text NOT NULL,
	"email" text,
	"token" text NOT NULL,
...
CREATE TABLE "team_seasons" (
	"id" integer PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY (sequence name "team_seasons_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START WITH 1 CACHE 1),
	"team_id" integer NOT NULL,
	...
	"average_scored" double precision DEFAULT 0 NOT NULL,
	"average_conceded" double precision DEFAULT 0 NOT NULL,
	"removed_at" text,
